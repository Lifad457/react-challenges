...
import Buttons from "../components/original-calculator/Buttons"
import Display from "../components/original-calculator/Display"
import calculateResult from "../utilities/calculateResult"
import getNum from "../utilities/getNum"
import { CalculatorContainer } from "../styles/original-calculator/original-calculator.css"
import GlobalStyle from "../styles/original-calculator/global.css"

export default function OriginalCalculator() {
    const INITIAL_STATE = {
        currentNum: [],
        previousNum: [],
        operation: undefined,
