...
import CheckAnswerButton from "../components/math-o-matic/CheckAnswerButton"
import GetNewProblemButton from "../components/math-o-matic/GetNewProblemButton"
import StartButton from "../components/math-o-matic/StartButton"
import GlobalStyle from "../styles/math-o-matic/global.css"
import { ButtonContainer, MessageContainer, ProblemContainer, Wrapper } from "../styles/math-o-matic/math-o-matic.css"


export default function MathOMatic() {
        ...
        <>
            ...
            <Wrapper>  
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <label>
                        {gameStarted && <ProblemContainer>{mathProblem.string}</ProblemContainer>}
                        <input 
                            type="number" 
                            name="value"
                            placeholder="?"
